...
// Requests that open, utilize, and close the skill
...
// Variable slots used for the skill i.e FirstName
...
var Response = function (context, session) {
  // variable to hold what is said by Alexa
  this.speechText = '';
  // variable to close the skill
  this.shouldEndSession = true;
  // variable for helper speech functionality
  this.ssmlEn = true;
...
----------Will add additional functionality for Alexa memory and In-app purchases for V2--------------
**/
